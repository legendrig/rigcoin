...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Rigcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"rigcointools.com", "rigcointools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"rigcointools.com", "testnet-seed.rigcointools.com"},
    {"xurious.com", "testnet-seed.rig.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Rigcoin is probably already running."), addrBind.ToString().c_str());
        else
